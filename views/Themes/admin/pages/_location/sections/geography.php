...
?><div class="setting-header cleafix">
	...
	<div class="rfloat">
		...
		<a class="btn btn-blue" data-plugins="lightbox" href="<?=$this->direction?>add/geography/"><i class="icon-plus mrs"></i><span><?=Translate::Val('Add New')?></span></a>

	</div>

	<div class="setting-title"><i class="icon-check-square-o mrs"></i>Geography</div>
</div>

<section class="setting-section">
	<table class="settings-table admin"><tbody>
		<tr>
			<th class="name">geography</th>
		...
		<tr data-id="<?=$item['id']?>">
			<td class="name fwb"><?php
				...
				echo '<a href="'.$this->direction.'edit/geography/'.$item['id'].'" data-plugins="lightbox">'.$item['name'].'</a>';
			?></td>
			...
			<td class="actions whitespace">
				...
				$dropdown[] = array(
	                ...
	                'href' => $this->direction.'edit/geography/'.$item['id'],
				...
				$dropdown[] = array(
	                ...
	                'href' => $this->direction.'del/geography/'.$item['id'],
	                'attr' => array('data-plugins'=>'lightbox'),
	                // 'icon' => 'remove'
	            );
