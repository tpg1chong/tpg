...
$this->model = 'payment_options';

?><div class="setting-header cleafix">

	<div class="rfloat">

		<a class="btn btn-blue" data-plugins="lightbox" href="<?=$this->direction?>add/<?=$this->model?>/"><i class="icon-plus mrs"></i><span><?=Translate::Val('Add New')?></span></a>
	...
	<table class="settings-table admin"><tbody>
		...
		<tr data-id="<?=$item['id']?>">
			<td class="name fwb"><?php
				...
				echo '<a href="'.$this->direction."edit/{$this->model}/{$item['id']}/".'" data-plugins="lightbox">'.$item['name'].'</a>';
			?></td>
			...
			<td class="actions whitespace">
				...
				$dropdown[] = array(
	                ...
	                'href' => $this->direction."edit/{$this->model}/{$item['id']}/",
				...
				$dropdown[] = array(
	                ...
	                'href' => $this->direction."del/{$this->model}/{$item['id']}/",
	                'attr' => array('data-plugins'=>'lightbox'),
	                // 'icon' => 'remove'
	            );
